...
export const DEFAULT_BINDINGS: ReadonlyArray<Omit<Binding, "chord" | "custom">> = [
  ...
  { action: "pane-split-right", label: "Split right", group: "Panes", default_chord: "Ctrl+Shift+D" },
  { action: "pane-split-down", label: "Split down", group: "Panes", default_chord: "Ctrl+Shift+E" },
