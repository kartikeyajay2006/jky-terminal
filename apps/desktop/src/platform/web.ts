...
const WEB_COMMANDS: CommandSpec[] = [
  ...
  },
  {
    ...
    detail:
      "With no argument it prints all five games with the best score each has been beaten with. Give it 1 through 5 and that game opens in the window: 1 Dino Run, 2 Snake, 3 Tic Tac Toe, 4 Flappy Bird, 5 2048.",
  },
  {
